...
use App\Exports\Billing\EnterpriseReportsExport;
use App\Mail\Admin\Billing\EnterpriseBillingReport as AdminEnterpriseBillingReport;
// use App\Mail\Billing\EnterpriseBillingReport;
// use App\Repositories\Invoicing\InvoicingRepository;
use Illuminate\Support\Facades\Mail;
use Carbon\Carbon;

class SendEnterpriseReportsAndInvoices extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'velo:billing:sendEnterpriseReportsAndInvoices';
    ...
    public function handle()
    {
        ...
        //         ->send(new EnterpriseBillingReport(Carbon::now()->format('Y-m'), $invoicingRepo->generateProformaInvoice($store), Excel::raw(new BillingReportsExport($store), BaseExcel::XLSX)));
        // }
